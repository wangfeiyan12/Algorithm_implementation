...
public class Dota2 {
    ...
    public static String getWinner(String input) {
        ...
        while(!qr.isEmpty() && !qd.isEmpty()){
            int r = qr.poll(); // get the first element from the right queue. This will be the winner. The left queue will be empty.
            int d= qr.poll(); // get the first element from the right queue. This will be the winner. The left queue will be empty.
        }
